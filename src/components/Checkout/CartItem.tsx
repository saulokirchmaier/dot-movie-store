...
export function CartItem({ item }: CartItemProps) {
  ...
  return (
    <motion.div
      ...
      className="flex items-center bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors relative"
    >
      <div className="w-full flex gap-3 p-2 rounded-md relative group">
